type IconTone = "base" | "success" | "warning" | "critical" | "info" | "subdued"
...
export function statusIconForTone(tone: "" | "ok" | "error" | "pending") {
  if (tone === "ok") return checkCircleIcon("success")
  if (tone === "error") return alertCircleIcon("critical")
  if (tone === "pending") return spinnerIcon()
